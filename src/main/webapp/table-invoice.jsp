        ...
        <div class="container mt-5 my-5">
            ...
            <form>
                <div class="row mt-5">
                    <div class="col-md-6">
                        <div class="row mb-3">
                            <label for="inputInvoiceId" class="form-label">Mã hoá đơn</label>
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="text" class="form-control" id="inputInvoiceId"
                        ...
                        <div class="row mb-3">
                            <label for="inputStatus" class="form-label">Tình trạng</label>
                            <div class="row">
                                <div class="col-md-12">
                                    <select class="form-select" id="inputStatus">
                                        <option value="1">Hoàn tất</option>
                                        <option value="2">Trì hoãn</option>
